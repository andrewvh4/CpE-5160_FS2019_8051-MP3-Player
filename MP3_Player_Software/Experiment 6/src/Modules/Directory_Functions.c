...
/********  Comment out Print_Directory function until it is needed to prevent data memory overflow *****/
...
/********  Comment out Read_Dir_Entry function until it is needed to prevent data memory overflow *****/
